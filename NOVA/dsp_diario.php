      ...
      <?php else: ?>
        <?php foreach ($entradas as $entrada): ?>
          <div class="card shadow-sm mb-4">
            <div class="card-body">
              <div class="card-header text-center py-3" style="background-color:#757575; border: 1px; border-radius: 15px;">
              <h5 class="card-title mb-0" style="color: white;"><?= htmlspecialchars($entrada['titulo']) ?></h5>
              </div>
              </br>
